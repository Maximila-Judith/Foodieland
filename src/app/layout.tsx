  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <footer className="mt-auto w-full 3xl:text-6xl py-10 px-4 sm:px-6 mx-auto">
          <div className="flex lg:flex-row flex-col items-center justify-between gap-6 mb-5">
            <div className="col-span-full lg:col-span-2 space-y-5">
              ...
              <p className="text-gray-300 text-md 3xl:text-4xl">Lorem ipsum dolor sit amet, consectetuipisicing elit, </p>
            </div>
            ...
            <div className="sm:flex sm:justify-between sm:items-center">
              <div className="flex flex-wrap flex self-center items-center gap-3">
                <div className="space-x-4 text-sm ">
                  <a className="inline-flex gap-x-2 3xl:text-4xl text-gray-600 text-base hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-black" href="#">© 2020 Flowbase. Powered by <span className="text-red-400">Webflow</span></a>
                </div>
              </div>
