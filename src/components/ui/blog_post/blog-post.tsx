        ...
        <div className='mt-10 mb-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-5 justify-center m-20'>
                <div className='col-span-4 w-[95%] flex flex-col gap-y-20'>
                    ...
                    <div className='flex items-center justify-center w-full h-40 w-[830px] bg-gray-200'>
                        <p className='text-left p-8 text-black tracking-wide italic text-3xl'>“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac ultrices odio.”</p>
                    </div>
            ...
            <div className='flex flex-col items-center mt-20 mb-20 gap-y-10'>
                <h1 className='font-bold text-4xl items-center text-black'>Check out the delicious recipe</h1>
