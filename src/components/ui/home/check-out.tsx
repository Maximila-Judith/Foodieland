...
export const Checkout = () => {
    return (
        <div className='flex flex-col gap-y-20 bg-gradient-to-t from-[#E7F9FD] to-transparent justify-center 3xl:mt-80 mt-20 p-10 pb-40'>
            <div className='flex flex-col items-center space-y-5'>
                <h1 className='font-bold text-4xl text-black 3xl:text-9xl'>Check out @foodieland on Instagram</h1>
                <p className='text-gray-400 text-md text-center 3xl:text-[40px]'>Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore <br /> magna aliqut enim ad minim </p>
            </div>

            <div className='grid grid-col-1 md:grid-cols-2 lg:grid-cols-4 3xl:grid-cols-4 3xl:gap-20 gap-10 mt-10'>
                <div className='bg-white'>
                    <div className='flex flex-rows bg-white items-center justify-between p-2'>
                        <div className='flex flex-rows items-center 3xl:space-x-10 space-x-3'>
                            <Image
                                src="/Images/Oval.png"
                                alt="icon 1"
                                width={40}
                            ...
                            <div className='flex flex-col space-y-1'>
                                <h3 className='flex flex-row 3xl:text-5xl text-sm items-center space-x-2 font-bold text-black'>
                                    Foodieland.
                                    <Image
                                ...
                                <p className='text-sm text-neutral-500 3xl:text-3xl'>Tokyo, Japan</p>
                            </div>
                        </div>
                    ...
                    <div className='flex flex-col space-y-3 items-center pt-3 pr-3 pl-3 pb-4'>
                        <div className='flex flex-row 3xl:justify-between w-full justify-center gap-8 '>
                        ...
                        <div className='flex flex-col space-y-5 w-full text-black'>
                            <div className='flex flex-row items-center space-x-2 pt-4'>
                                <Image
                                    ...
                                    height={18}
                                    priority
                                    className="opacity-100 rounded-xl 3xl:w-[60px]"
                                />
                                <p className='text-black text-sm 3xl:text-4xl'>Liked by craig_love and 44,686 others</p>
                            </div>
                            <p className='text-sm 3xl:text-4xl'>Foodieland. The vegetables dishes need to have certain vitamin for those people</p>
                            <span className='text-gray-400 text-sm 3xl:text-4xl'>September 19</span>
                        </div>
                    </div>
            ...
            <div className='flex justify-center'>
                <button className='flex flex-rows 3xl:w-[700px] 3xl:p-8 3xl:space-x-6 3xl:rounded-3xl w-[200px] justify-center items-center space-x-3 p-4 border rounded-2xl bg-black text-white'>
                    <p className='text-sm 3xl:text-6xl'>Visit Our Instagram</p>
                    <a href="#" className="text-black 3xl:text-3xl">
