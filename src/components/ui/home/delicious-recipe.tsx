...
export const Delicious = () => {
    return (
        <div className='w-full flex flex-col justify-center items-center mt-20 gap-y-10'>
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-2 items-center gap-10 md:gap-80'>
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-4 gap-3 pl-8 pr-8'>
