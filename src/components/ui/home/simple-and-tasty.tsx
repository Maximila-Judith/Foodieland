...
export const Simple_tasty = () => {
    return (
        <div className='flex flex-col gap-y-20 mt-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 pl-8 pr-8'>
                <div className='relative flex flex-col space-y-8 bg-gradient-to-t from-[#E7F9FD] to-transparent pl-4 pr-4 pb-5 rounded-2xl'>
